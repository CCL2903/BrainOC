...
i686-elf-gcc -O2 -std=gnu99 -Wall -Wextra -ffreestanding -g -c src/tty.c -o bin/tty.o
i686-elf-gcc -O2 -std=gnu99 -Wall -Wextra -ffreestanding -g -c src/ports.c -o bin/ports.o
i686-elf-gcc -O2 -std=gnu99 -Wall -Wextra -ffreestanding -g -c src/CMOS.c -o bin/CMOS.o
